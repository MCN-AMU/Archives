...
print("[INFO] running on {} platform - arch {}".format(platform.system(), machine ))
...
ap.add_argument("-t", "--host", type=str, default="127.0.0.1", help="OSC remote address IP or host name")
ap.add_argument("-p", "--port", type=int, default=5000, help="OSC remote port")
ap.add_argument("-d", "--debug", action='store_true', help="Show window and output events (decrease performance)")
